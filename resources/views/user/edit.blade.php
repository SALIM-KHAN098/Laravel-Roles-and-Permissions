                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-4 gap-4 mb-5">
                                        ...
                                        <div class="items-center">
                                            <input {{ ($hasRoles->contains($role->id)) ? 'checked':'' }} id="role-{{ $role->id }}" name="role[]" type="checkbox" value="{{ old('role[]', $role->name) }}" class="w-4 h-4 text-blue-600 bg-white-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-white-700 dark:border-white-600">
