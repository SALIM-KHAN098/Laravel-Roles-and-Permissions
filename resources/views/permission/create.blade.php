<x-app-layout>
    <x-slot name="header">
        <div class="heading flex justify-between">
            ...
            <a href="{{ route('permissions.index') }}" type="button" class="px-3 mr-2 py-2 text-xs font-medium text-center text-white bg-gray-900 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-900 dark:bg-gray-900 dark:hover:bg-gray-800 dark:focus:ring-black-800">Back</a>
                ...
                <div class="p-6 text-gray-900">
                    <div class="permission-table">
                        ...
                        <form action="{{ route('permissions.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <h2 class="text-4xl font-bold dark:text-black mb-4">Permissions Create</h2>
