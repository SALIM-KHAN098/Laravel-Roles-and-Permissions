                ...
                <div class="p-6 text-gray-900">
                    <div class="permission-table">
                        ...
                        <form action="{{ route('roles.update', $role->id) }}" method="POST">
                            @csrf
                            @method('PATCH')
                            <h2 class="text-4xl font-bold dark:text-black mb-4">Role Edit</h2>
                            ...
                            <div class="grid grid-cols-4 gap-4 mb-5">
                                ...
                                <div class="items-center">
                                    <input {{ ($hasPermissions->contains($permission->name)) ? 'checked' : '' }} id="permisssion-{{ $permission->id }}" name="permission[]" type="checkbox" value="{{ old('permission[]', $permission->name) }}" class="w-4 h-4 text-blue-600 bg-white-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-white-700 dark:border-white-600">
