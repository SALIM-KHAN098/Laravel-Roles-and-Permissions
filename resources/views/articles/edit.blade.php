                ...
                <div class="p-6 text-gray-900">
                    <div class="permission-table">
                        ...
                        <form action="{{ route('articles.update', $article->id) }}" method="POST">
                            @csrf
                            @method('PATCH')
                            <h2 class="text-4xl font-bold dark:text-black mb-4">Article Edit</h2>
